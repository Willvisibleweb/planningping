// Terms of Service — approved copy, pasted verbatim.
// Only markdown structure (headings, bullet lists) has been added for rendering;
// no wording has been changed. To update the Terms, edit this string.
// Last updated: 16/6/26

export const termsLastUpdated = '16/6/26'

export const termsMarkdown = `# PlanningPing — Terms of Service
