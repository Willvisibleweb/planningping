...
//
// Once one exists it is cached on the application row and shared by everyone,
// so it renders immediately on arrival and the button never appears again.
...
export default function ApplicationSummary({
  ...
  // Already generated by someone, and cached on the row. Costs nothing to
  // show, so it is shown rather than hidden behind a button that would return
